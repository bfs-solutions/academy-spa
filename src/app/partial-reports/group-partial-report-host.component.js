...
import groupPartialReportHostTemplate
    from './group-partial-report-host.component.html';

class GroupPartialReportHostController {
...
export const GroupPartialReportHostComponent = {
    controller: GroupPartialReportHostController,
    template: groupPartialReportHostTemplate
};