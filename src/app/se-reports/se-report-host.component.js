...
import SEReportHostTemplate
    from './se-report-host.component.html';

class SEReportHostController {
...
export const SEReportHostComponent = {
    controller: SEReportHostController,
    template: SEReportHostTemplate
};