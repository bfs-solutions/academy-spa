...
import subjectHalfTemplateHostTemplate
    from './subject-half-template-host.component.html';
...
export const SubjectHalfTemplateHostComponent = {
    controller: SubjectHalfTemplateHostController,
    template: subjectHalfTemplateHostTemplate
};